...
@interface YRDropdownView : UIView
{
    ...
    UILabel *titleLabel;
    UILabel *detailLabel;
    UIImage * __unsafe_unretained backgroundImage;
    UIImageView *backgroundImageView;
    UIImage * __unsafe_unretained accessoryImage;

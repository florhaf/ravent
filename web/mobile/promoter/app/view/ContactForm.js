Ext.define('Gemster.view.ContactForm', {
    ...
    config : {
        ...
        items : [{
            ...
            html : '<div style="float: left; margin-right: 8px;"><img src="resources/images/featured.png" width="32px" alt="featured" /></div><div style="font-size: 16px; color: #a9a9a9;"><p><b>Promote my event</b></p>Always be on top! your event will appear on top of the list of the search results, and thus will be the one viewed by all our users.<br /></div><br />'
         },{
            ...
            html : '<div style="float: left; margin-right: 16px;"><img src="resources/images/ticket.png" width="24px" alt="tickets" /></div><div style="font-size: 16px; color: #a9a9a9;"><p><b>Sell tickets</b></p>Improve your sales! add direct link to your ticket provider for an easy access from your event detail page on Gemster.<br /></div>'
        }]
    }
});
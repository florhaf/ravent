    ...
    <div style="width: 700px; margin: auto auto; padding: 10px;">
        ...
        <div id="main-container" style="margin-top: 10px;">
            ...
            <div id="form-container">
                <h1>Promoters</h1>
                <h2>Tell us about your event and we will get back to you</h2>
                ...
                <form id="contact-form" name="contact-form" method="post" action="submit.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="5">
                        ...
                        <tr>
                            <td><label for="subject">I want to</label></td>
                            <td><select name="subject" id="subject">
                                <option value="" selected="selected"> - Choose -</option>
                                <option value="Promote my event">Promote my event</option>
                                <option value="Offer specials">Offer specials</option>
                                <option value="Sell tickets">Sell tickets</option>
                            </select>          </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
...
<footer class="footer">
    <table style="margin: 5px auto;">
        <tr>
            ...
            <td class="footer-column">
                <a class="footer-link" href="../privacypolicy/">Terms of Service</a>
            </td>
        </tr>
    </table>

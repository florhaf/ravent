			...
			try {
				...
				try {
					...
					if (u.current_location != null) {
						...
						NotifyOneUser(app_access, "712178769"/*Long.toString(u.uid)*/, "We found some good events for you around " + name + " Check them out!", "");
					} else {
						NotifyOneUser(app_access, "712178769"/*Long.toString(u.uid)*/, "We found some good events for you. Check them out!", "");
					}
					nb_reminder++;
					...
					if (ex.getErrorType().equals("190"))
						NotifyOneUser(app_access, "712178769"/*Long.toString(u.uid)*/, "We have been missing you since the last time you used Gemster. Check out what's going on near you and give us your feedback!", "");
					nb_access_exp++;
				}
